...
def update_approve_status_view(request,pk):
    ...
    if stock.unit > unit:
        ...
        send_email(req.patient.user.email,"Blood Request Approved","Your blood request has been approved")
    else:
...
def update_reject_status_view(request,pk):
    ...
    send_email(req.patient.user.email,"Blood Request Rejected","Your Blood Request Has Been Rejected")
...
def approve_donation_view(request,pk):
    ...
    send_email(donation.donor.user.email,"Blood Donation Approved","Your Blood Donation Has Been Approved")
...
def reject_donation_view(request,pk):
    ...
    send_email(donation.donor.user.email,"Blood Donation Rejected","Your Blood Donation Has Been Rejected")
